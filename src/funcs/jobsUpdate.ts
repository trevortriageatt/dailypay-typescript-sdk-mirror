...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateJobRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.JobUpdateData, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateJobResponse$inboundSchema, {
      ctype: "application/vnd.api+json",
      key: "JobData",
    }),
    M.jsonErr(400, errors.JobUpdateError$inboundSchema, {
      ctype: "application/vnd.api+json",
    }),
