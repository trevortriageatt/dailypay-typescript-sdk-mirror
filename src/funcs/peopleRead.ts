 ...
 */
export function peopleRead(
  client: SDKCore,
  request: operations.ReadPersonRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ReadPersonResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ReadPersonRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ReadPersonResponse$inboundSchema, {
