 ...
 */
export function jobsRead(
  client: SDKCore,
  request: operations.ReadJobRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ReadJobResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ReadJobRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ReadJobResponse$inboundSchema, {
