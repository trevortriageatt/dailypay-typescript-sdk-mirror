...
func pathGetRestJobs(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
	return func(w http.ResponseWriter, req *http.Request) {
		...
		case "listJobs[0]":
			dir.HandlerFunc("listJobs", testListJobsListJobs0)(w, req)
		default:
...
func testListJobsListJobs0(w http.ResponseWriter, req *http.Request) {
	...
	var respBody *components.JobsData = &components.JobsData{
		Data: []components.JobResource{
			components.JobResource{
