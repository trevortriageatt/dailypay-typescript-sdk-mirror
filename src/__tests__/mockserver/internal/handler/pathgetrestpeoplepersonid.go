...
func pathGetRestPeoplePersonID(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
	return func(w http.ResponseWriter, req *http.Request) {
		...
		case "readPerson[0]":
			dir.HandlerFunc("readPerson", testReadPersonReadPerson0)(w, req)
		default:
...
func testReadPersonReadPerson0(w http.ResponseWriter, req *http.Request) {
